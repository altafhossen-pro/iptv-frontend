...
const ChannelManagement = () => {
    ...
    const fetchChannels = async (page = 1, category = '', quality = '', limit = 20) => {
        try {
            setLoading(true);
            ...
            const response = await fetch(`${process.env.NEXT_PUBLIC_API_URL}/api/v1/channel?${params}`);
    ...
    useEffect(() => {
        ...
        fetchChannels(1, categorySlug, selectedQuality);
        ...
        if (window.confirm('Are you sure you want to delete this channel?')) {
            try {
                ...
                if (data.success) {
                    ...
                    fetchChannels(pagination.current_page,
    ...
    const handlePageChange = (newPage) => {
        if (newPage >= 1 && newPage <= pagination.total_pages) {
            const categorySlug = categories.find(cat => cat._id === selectedCategory)?.slug || '';
            fetchChannels(newPage, categorySlug, selectedQuality);
        }
    };
                ...
                <div>
                    ...
                    <div className="flex justify-between items-center mb-6">
                        <div>
                            ...
                            <p className="text-gray-600 mt-1">Manage your streaming channels</p>
                        </div>
                        <button
                        ...
                        <div className="bg-white rounded-lg shadow-sm border border-gray-200 p-6">
                            <div className="flex items-center justify-between">
                                <div>
                                    ...
                                    <p className="text-2xl font-bold text-green-600">{channels.filter(ch => ch.is_online).length}</p>
                                </div>
                        ...
                        <div className="bg-white rounded-lg shadow-sm border border-gray-200 p-6">
                            <div className="flex items-center justify-between">
                                <div>
                                    ...
                                    <p className="text-2xl font-bold text-purple-600">{channels.filter(ch => ch.is_premium).length}</p>
                                </div>
                        ...
                        <div className="bg-white rounded-lg shadow-sm border border-gray-200 p-6">
                            <div className="flex items-center justify-between">
                                <div>
                                    ...
                                    <p className="text-2xl font-bold text-orange-600">{channels.reduce((sum, ch) => sum + (ch.viewer_count || 0), 0)}</p>
                                </div>
